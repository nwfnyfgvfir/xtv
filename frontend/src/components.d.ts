...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DirectoryPickerDialog: typeof import('./components/DirectoryPickerDialog.vue')['default']
    ...
    ExternalPlayersBar: typeof import('./components/ExternalPlayersBar.vue')['default']
